  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="{{ route('customer.customer.login') }}" method="POST" class="sign-in-form">
          @csrf
          <h2 class="title">Connexion Client</h2>
          ...
          <p style="display: flex;justify-content: center;align-items: center;margin-top: 20px;"><a href="{{ route('customer.password.reset') }}" style="color: #4590ef;"> <i style="text-decoration: underline;margin-right:4px;" class="fas fa-unlock"></i> Mot de passe oublié? </a></p>
        </form>
