...
@section('main-content')
    <section class="section p-0 sectionCompteMobile">
        <div class="container">
            <div class="row login-client">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary">Compte client TouCki</h5>
                                    </div>
                                </div>
    ...
    <div class="account-pages sectionCompteDesktope my-5 pt-sm-5 mt-5">
        <div class="container">
