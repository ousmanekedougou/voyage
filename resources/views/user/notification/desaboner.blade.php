                        ...
                        <div class="card overflow-hidden">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary">Page de desabonnement</h5>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    ...
                                    @else
                                    <div class="alert alert-success text-center mb-4" role="alert">
                                        Entrez votre email pour vous desabonner
                                    </div>
                                    @endif
                                    <form class="form-horizontal" method="POST" action="{{ route('contact.dislogin') }}">
                                        @csrf
                                        {{Method_field('PUT')}}
                                        <div class="mb-3">
