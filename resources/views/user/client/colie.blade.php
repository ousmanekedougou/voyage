...
@section('main-content')
            ...
            <!-- hero section end -->
                ...
                <!-- currency price section start -->
                    <section class="section bg-white p-0 sectionCompteDesktope">
                        <div class="container">
                                                                ...
                                                                <div class="table-responsive">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ $colieClient->quantity }} </td>
                                                                                <td>{{ $colieClient->getAmountUnitaire() }} </td>
                                                                                ...
                                                                                <td>
                                                                                {{ $colieClient->ville->name }} {{$colieClient->code_validation}}
                                                                                </td>
                                                                            </tr>
                                                                            @endforeach
            ...
            <div class="container">
                ...
                <div class="table-responsive sectionCompteMobile" style="margin-top:-3rem;">
                        ...
                        <li class="mb-4">
                            <div class="media">
                                <div class="align-self-center">
                                    <div class="align-self-center me-3">
                                        ...
                                        @if($getClientColie->colie->siege->agence->image != Null)
                                            {{Storage::url($getClientColie->siege->agence->image)}}
                                        @else
                                            https://ui-avatars.com/api/?name={{$getClientColie->colie->siege->agence->name}}
                                        @endif
                                ...
                                <div class="media-body overflow-hidden">
                                    ...
                                    <p class="text-truncate mb-0">Siege de {{ $getClientColie->colie->siege->name }}</p>
                                </div>
                        ...
                        @foreach($coli_clients as $colie)
                            <tbody class="card col-lg-4">
                                ...
                                <tr>
                                    ...
                                    <td class="td-mobile">{{$colie->quantity}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td-mobile">{{ $colie->ville->name }} {{ $colie->code_validation }}</td>
                                </tr>
                                <tr>
