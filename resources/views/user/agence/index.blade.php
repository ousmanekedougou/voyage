        ...
        <div class="container">
                ...
                <div class="col-lg-8 card_show">
                    <div class="text-white-50">
                        <h1 class="text-white font-weight-semibold mb-3 hero-title ">Voyage par tout au senegal avec nos agences </h1>
                        <p class="font-size-20" >
                            Plus de {{$agences->count()}} compagnies de voyages nous font confiance pour vendre leurs billets sur une seule plateforme.
                        </p>
                    </div>
                </div>
            </div>
