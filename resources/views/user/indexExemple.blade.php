...
@section('main-content')
  <!-- hero section start -->
    ...
    <!-- Features start -->
    <section class="section bg-white sectionCompteDesktope mt-5" id="features">
        <div class="container">
                 ...
                 <div class="col-md-6">
                    <div>
                        ...
                        <div class="button-items mb-3 text-center">
                            <a href="" class="btn btn-primary"> <i class="fa fa-download"></i> Télécharger le logiciel TouCki</a>
                        </div> 
                    </div>
                </div>
            </div>
