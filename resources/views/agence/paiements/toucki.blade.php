                    ...
                    <li class="mb-4">
                        <div class="media">
                            <div class="align-self-center me-3">
                                <img src="@if(Auth::guard('agence')->user()->logo == '') https://ui-avatars.com/api/?name={{Auth::guard('agence')->user()->name}} @else {{(Storage::url(Auth::guard('agence')->user()->logo))}} @endif" class="rounded-circle avatar-sm" alt="">
                            </div>
