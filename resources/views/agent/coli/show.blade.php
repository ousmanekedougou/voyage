                                                    ...
                                                    @foreach($coli->coli_clients as $bag)
                                                        @if($bag->status == 0)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($bag->status == 1)
                                                                        <span class="text-success">Par
                                                                            ...
                                                                            @else
                                                                                {{ $bag->name_recept }} | {{ $bag->phone_recept  }}
                                                                            @endif
                                                                    @else
                                                                ...
                                                                <td>
                                                                    @if($bag->recu == 0)
                                                                        <a href="javascript:void(0);" class="action-icon text-success" data-bs-toggle="modal" data-bs-target="#ColiRecue-{{$bag->id}}"><i class="bx bx-check font-size-18"></i></a>
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <th> Quantite : {{ $coli->coli_clients->count() }}</th>
                                                            
                                                                
                                                                <th> Total : {{$coli->getAmountTotal()}}</th>
                                                                <th>
                        ...
                        <li class="mb-4">
                            <div class="media">
                                <div class="align-self-center me-3">
                                    <div class="align-self-center me-3">
                                        @if($coli->image != Null)
                                            <img src="{{Storage::url($coli->image)}}" class="rounded-circle avatar-xs" alt="">
                                        @else
                                ...
                                <tbody class="card col-lg-4">
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            @if($bag->status == 0)
                                                <span class="action-icon badge bg-success btn-recept-mobile" role="button" aria-disabled="true" data-bs-toggle="modal" class="text-danger" data-bs-target="#ColiRecue-{{ $bag->id }}"> <i class="@if($bag->recepteurPay) mdi mdi-cart-arrow-right me-1 @else bx bx-check font-size-11 @endif"></i>@if($bag->recepteurPay == 1)Payer @else Valider @endif</span>
                                                <span class="action-icon badge bg-primary" data-bs-toggle="modal" data-bs-target="#EditBagage-{{$bag->id}}"> <i class="bx bx-edit font-size-11"></i> Modifier</span>
                                            ...
                                            @else
                                                <span class="action-icon font-size-12">Reçu par {{$bag->recepteur_info}} </span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-mobile">{{ $bag->name_recept }} | {{ $bag->phone_recept  }} </td>
                                    </tr>
